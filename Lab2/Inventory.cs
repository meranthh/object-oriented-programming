...
public class Inventory
{
    ...
    public void UseItem(string name)
    {
        ...
        item.Use();
        _items.Remove(item);
        Console.WriteLine($"{item.Name} был использован и удален из инвентаря.");
    }
    ...
    {
        return _items.FirstOrDefault(i => i.Name == name) ?? throw new InvalidOperationException("Предмет не найден.");
    }
